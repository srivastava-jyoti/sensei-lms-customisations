...
return o.createElement("svg",i({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},e),r||(r=o.createElement("path",{d:"M16.181 17.381a7.61 7.61 0 0 1-2.13.133L15.778 20H18l-1.819-2.619zm-5.479-.953a7.712 7.712 0 0 1-2.12-1.928H5.5v-9h2.759A7.793 7.793 0 0 1 9.523 4H4v12h4.778L6 20h2.222l2.48-3.572zM15.541 8.944h-1.5v3.997h1.5V8.944zm0-1h-1.5V6.55h1.5v1.395z"})),s||(s=o.createElement("path",{d:"M20.79 9.768c0 3.425-2.714 6.269-6.145 6.269-3.43 0-6.145-2.844-6.145-6.269 0-3.424 2.714-6.268 6.145-6.268 3.43 0 6.145 2.844 6.145 6.268zm-6.145 4.769c2.565 0 4.645-2.135 4.645-4.769C19.29 7.135 17.21 5 14.645 5 12.08 5 10 7.135 10 9.768c0 2.634 2.08 4.769 4.645 4.769z"})))};
/***/},
/***/33731:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */Z:()=>d
/* harmony export */});
/* harmony import */var r=n(25773),s=n(53782),o=n(69307),i=n(60042),l=n.n(i),a=n(55609),c=n(65736),u=["className","id","label","value","help","allowReset","resetLabel","onChange","suffix","hideLabelFromVision"],__=c.__;
/* harmony import */
/* harmony default export */const d=function(e){var t=e.className,n=e.id,i=e.label,c=e.value,d=e.help,p=e.allowReset,m=void 0!==p&&p,f=e.resetLabel,v=e.onChange,b=e.suffix,h=e.hideLabelFromVision,y=(0,s/* ["default"] */.Z)(e,u);return(0,o.createElement)(a.BaseControl,{id:n,label:i,help:d,hideLabelFromVision:h},(0,o.createElement)("div",{className:"sensei-number-control"},(0,o.createElement)("div",{className:"sensei-number-control__input-container"},(0,o.createElement)("input",(0,r/* ["default"] */.Z)({className:l()("sensei-number-control__input components-text-control__input",t),type:"number",id:n,onChange:function(e){v(parseInt(e.target.value,10)||y.min||0)},value:null===c?"":c},y)),b&&(0,o.createElement)("span",{className:"sensei-number-control__input-suffix"},b)),m&&(0,o.createElement)(a.Button,{className:"sensei-number-control__button",isSmall:!0,isSecondary:!0,onClick:function(){return v(null)}},f||__("Reset","sensei-lms"))))};
/***/},
/***/32016:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
/* harmony export */Z:()=>m
/* harmony export */});
/* harmony import */var r,s=n(50189),o=n(69307),i=n(4981),l=n(52175),a=n(9818),c=n(59678),u=n(36383),d=[["core/video"]],p=["core/embed","core/video","sensei-pro/interactive-video"];
/* harmony import */
/* harmony default export */const m=(0,s/* ["default"] */.Z)((0,s/* ["default"] */.Z)({},c),{},{metadata:c,example:{innerBlocks:[{name:"core/image",attributes:{url:"".concat(null===(r=window.sensei)||void 0===r?void 0:r.assetUrl,"/images/featured-video-example.png")}}]},edit:function(e){var t=e.className,n=e.clientId,r=(0,a.useDispatch)("core/block-editor"),s=r.replaceInnerBlocks,c=r.moveBlockToPosition,u=(0,a.useSelect)((function(e){return e("core/block-editor").getBlocks(n).length})),m=(0,o.useRef)(u);(0,o.useEffect)((function(){m.current>0&&0===u&&s(n,[(0,i.createBlock)("core/video")],!1),m.current=u}),[u,n,s]);var f=(0,a.useSelect)((function(e){var t=e("core/block-editor"),r=t.getBlockParents,s=t.getBlockRootClientId,o=t.getBlockIndex;return{parentBlocks:r(n),rootClientId:s(n),blockIndex:o(n)}}),[n]),v=f.parentBlocks,b=f.rootClientId,h=f.blockIndex;// Move Featured Video block to top at top level.
return(0,o.useEffect)((function(){(null!=v&&v.length||h)&&c(n,b,"",0)}),[v,b,h,c,n]),(0,o.createElement)("div",{className:t},(0,o.createElement)(l.InnerBlocks,{allowedBlocks:p,template:d,renderAppender:!1}))},save:function(){return(0,o.createElement)(l.InnerBlocks.Content,null)},transforms:u/* .transforms */.L});
/***/},
/***/36383:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(4981),s=n(59678),o={from:["core/video","core/embed","sensei-pro/interactive-video"].map((function(e){return{type:"block",blocks:[e],transform:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],o=e;return"core/embed"!==o||t.providerNameSlug||(o="core/video"),(0,r.createBlock)(s.name,{},[(0,r.createBlock)(o,t,n)])}}})),to:["core/video","core/embed","sensei-pro/interactive-video"].map((function(e){return{type:"block",blocks:[e],isMatch:function(t){var n,r;return e===(null===(n=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).innerBlocks)||void 0===n||null===(r=n[0])||void 0===r?void 0:r.name)},transform:function(t){var n=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:[])[0]||{},s=n.attributes,o=void 0===s?{}:s,i=n.innerBlocks,l=void 0===i?[]:i;return(0,r.createBlock)(e,o,l)}}}))};
/* harmony import */}
/***/,
/***/83456:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */});
/* harmony import */var r=n(92694),s=n(65736),__=s.__,o=(0,r.applyFilters)("sensei-lms.Lesson.difficulties",[{label:__("None","sensei-lms"),value:""},{label:__("Easy","sensei-lms"),value:"easy"},{label:__("Standard","sensei-lms"),value:"std"},{label:__("Hard","sensei-lms"),value:"hard"}]);
/* harmony import */}
/***/,
/***/45824:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>l
/* harmony export */});
/* harmony import */var r=n(50189),s=n(25365),o=n(95826),i=n(9757);
/* harmony import */
/**
 * Internal dependencies
 */
/* harmony default export */const l=(0,r/* ["default"] */.Z)((0,r/* ["default"] */.Z)({},o),{},{metadata:o,icon:s/* ["default"] */.Z,example:{attributes:{difficulty:"easy",length:10}},edit:i/* ["default"] */.Z,save:function(){return null}});
/***/},
/***/9757:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
/* harmony export */Z:()=>y
/* harmony export */});
/* harmony import */var r,s,o=n(64649),i=n(50189),l=n(66886),a=n(69307),c=n(60042),u=n.n(c),d=n(37798),p=n(52175),m=n(55609),f=n(65736),v=n(80768),b=n(83456),__=f.__,_n=f._n,h=(null===(r=window)||void 0===r||null===(s=r.sensei)||void 0===s?void 0:s.courseThemeEnabled)||!1;
/* harmony import */
/* harmony default export */const y=function(e){var t,n=e.className,r=(0,d.useEntityProp)("postType","lesson","meta"),s=(0,l/* ["default"] */.Z)(r,2),c=s[0],f=s[1],y=c||{},g=y._lesson_complexity,w=void 0===g?"":g,Z=y._lesson_length,O=void 0===Z?10:Z,k=!c,x=(0,a.useCallback)((function(e,t){f((0,i/* ["default"] */.Z)((0,i/* ["default"] */.Z)({},c),{},(0,o/* ["default"] */.Z)({},e,t)))}),[c,f]);return(0,a.createElement)(a.Fragment,null,!k&&(0,a.createElement)(p.InspectorControls,null,(0,a.createElement)(m.PanelBody,{title:__("Properties","sensei-lms")},(0,a.createElement)(v/* ["default"] */.Z,{id:"sensei-lesson-length",label:__("Length","sensei-lms"),min:0,step:1,value:O,onChange:function(e){return x("_lesson_length",e)},suffix:_n("minute","minutes",O,"sensei-lms")}),(0,a.createElement)(m.SelectControl,{label:__("Difficulty","sensei-lms"),options:b/* .DIFFICULTIES.map */.D.map((function(e){return{label:e.label,value:e.value}})),value:w,onChange:function(e){return x("_lesson_complexity",e)}}))),h?(0,a.createElement)(m.Notice,{status:"warning",isDismissible:!1},__("Since Learning Mode is activated, use this block to add the properties to each lesson and make sure your Lesson template contains the Lesson Properties block.","sensei-lms")):(0,a.createElement)("div",{className:n},(0,a.createElement)("span",{className:u()("wp-block-sensei-lms-lesson-properties__length",{disabled:!O})},__("Length","sensei-lms")+": "+O+" "+_n("minute","minutes",O,"sensei-lms")),(0,a.createElement)("span",{className:u()("wp-block-sensei-lms-lesson-properties__separator",{disabled:!O||!w})},"|"),(0,a.createElement)("span",{className:u()("wp-block-sensei-lms-lesson-properties__difficulty",{disabled:!w})},__("Difficulty","sensei-lms")+": "+(null===(t=b/* .DIFFICULTIES.find */.D.find((function(e){return w===e.value})))||void 0===t?void 0:t.label))))};
/***/},
/***/53227:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
(()=>{"use strict";
/* harmony import */var e=n(53227),t=n(45824),r=n(32016);
/* harmony import */
/**
 * Internal dependencies
 */
(0,e/* ["default"] */.Z)([t/* ["default"] */.Z,r/* ["default"] */.Z])})()})
/******/();